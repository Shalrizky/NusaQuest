        ...
        <div className="card-wrapper d-flex justify-content-center align-items-center">
          <Card className="card-player">
            ...
            <Card.Body>
              ...
              <div className="card-image-container d-flex align-items-center gap-2">
                <Card.Img src={badge1} alt="badge" className="badge-image" />
        ...
        <div className="card-wrapper d-flex justify-content-center align-items-center">
          <Card className="card-player">
            ...
            <Card.Body>
              <Card.Title className="title">KAMAL ABRAR</Card.Title>
              <div className="card-image-container d-flex align-items-center gap-2">
                <Card.Img src={badge1} alt="badge" className="badge-image" width={50}/>
                <span className="badge-card-title">Master Kuliner</span>
              </div>
            </Card.Body>
          </Card>
        ...
        <div className="player-not-available">
          <Card className="player-not-available">
            <Card.Img
              variant="top"
              src={vector}
              className="vector-player img-fluid"
            />
            <Card.Body>
